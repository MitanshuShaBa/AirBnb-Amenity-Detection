...
IMAGE_PATHS = ['tmp/test/towel/2e2f6fce2c6297ec.jpg',
               'tmp/test/towel/3b91d367c4d179bc.jpg']
...
PATH_TO_MODEL_DIR = 'src/models/pre-trained-models/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8'
...
for image_path in IMAGE_PATHS:
    ...
    plt.imsave(f'{image_path.split("/")[-1]}.jpg', image_np_with_detections)
    print('Done')
plt.show()
